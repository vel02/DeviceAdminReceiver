...
public class CameraControllerV2WithoutPreview {
    ...
    private static CameraControllerV2WithoutPreview instance;

    private CameraControllerV2WithoutPreview(Context context) {
        this.weakReference = new WeakReference<>(context);
//        this.context = context;
    }

    public static CameraControllerV2WithoutPreview getInstance(Context context) {
        if (instance == null) {
            instance = new CameraControllerV2WithoutPreview(context);
        }
        return instance;
    }
    ...
    public void takePicture() {
        ...
        Toast.makeText(weakReference.get(), file.getAbsolutePath(), Toast.LENGTH_SHORT).show();
    }
...
//        File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "Camera2Test");
        ...
        File mediaStorageDir = new File(external_storage_directory + File.separator + "Camera2Test");
        ...
        File mediaFile;
        mediaFile = new File(external_storage_directory + File.separator + "Camera2Test" + File.separator + "IMG_" + timeStamp + ".jpg");
